...
const extractAndVerifyToken = async (headers) => {
    ...
    const endpoint = `${process.env.AUTH_ADDRESS}/verify-token/`;
...
const PORT = process.env.TASKS_SERVICE_PORT;
app.listen(PORT, () => console.log(`Tasks Service started running on http://localhost:${PORT}`));